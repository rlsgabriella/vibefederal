      ...
      <div className="container footer__inner">
        <div className="footer__brand">
          ...
          <p className="footer__tagline">
            Mapas mentais e trilhas por concurso para quem se prepara para a rede federal
            com leveza, foco e material alinhado ao edital.
          </p>
        ...
        <div className="footer__col">
          ...
          <ul>
            ...
            <li><Link to="/materiais">Ver todos os materiais →</Link></li>
